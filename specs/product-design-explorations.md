...
- Status: Historical design ideas
- Archived: 2026-09-05
- Superseded by: [Current product principles](../workout-app-principles.md)

These notes preserve the early design language formerly kept in
`workout-app-principles.md`. Checkboxes, exact timings, sound recipes, gestures,
and navigation suggestions below describe explorations, not unfinished work or
a current implementation contract. In particular, the former four-tab limit and
dark-first prescription are superseded: the app supports both appearances and
a maximum of five tabs. Consult the [spec index](index.md) for active behavior.

## Preserved exploration notes
