...
`vivobody/Resources/catalog.json`. The runtime catalog contains exactly the 51
active families and their 128 reviewed exercises; the synthetic fixture and
...
- The projection contains exactly 51 family IDs and 128 exercise records; it is
  stable under family file discovery order and excludes the synthetic fixture
  and supplemental `--family` validation inputs.
- The evidence registry contains exactly 146 source identities, each referenced
