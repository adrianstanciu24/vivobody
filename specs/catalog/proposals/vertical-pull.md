...
| Required stabilizer | `externalRotators`, `fingerFlexors`, `extensorCarpiRadialis`, plus at least one of `abs`, `obliques`, or `lumbarExtensors` | Glenohumeral control, explicit hand/wrist control, and strict trunk control. |
