...
#  muscle/equipment/movement direction/etc. fails loudly.
#
...
CURATION = {
    ...
    # ---- Shoulders ----
    "Overhead Press": ex("shoulders", "barbell", "compound", "push", direction="vertical", weight=95, reps=8,
    ...
    "Chest Press": ex("chest", "machine", "compound", "push", direction="horizontal", weight=90, reps=10,
                      prime=["pectorals"], major=["triceps"], minor=["deltoids"],
    ...
    "Seated Bench Press": ex("chest", "machine", "compound", "push", direction="horizontal", weight=90, reps=10,
                             prime=["pectorals"], major=["triceps"], minor=["deltoids"]),
    ...
    "Pendelay Rows": ex("back", "barbell", "compound", "pull", direction="horizontal", weight=135, reps=6,
                        prime=["lats", "rhomboids"], major=["traps", "biceps"],
    ...
    "Incline Dumbbell Row": ex("back", "dumbbell", "compound", "pull", direction="horizontal", weight=45, reps=10,
                               prime=["lats", "rhomboids"], major=["biceps"], minor=["traps", "teres"],
    ...
    "Rowing seated, narrow grip": ex("back", "cable", "compound", "pull", direction="horizontal", weight=100, reps=10,
                                     prime=["lats", "rhomboids"], major=["biceps"], minor=["traps", "teres"],
    ...
    "Inverted Lat Pull Down": ex("back", "cable", "compound", "pull", direction="vertical", weight=100, reps=10,
                                 prime=["lats", "biceps"], minor=["teres", "rhomboids", "traps", "deltoids", "forearms"],
                                 trace=["abs", "pectorals", "triceps"],
    ...
    "Assisted Pull-Up": ex("back", "machine", "compound", "pull", direction="vertical", weight=60, reps=10, bw=0.4,
                           prime=["lats"], major=["biceps"], minor=["teres", "rhomboids"],
    ...
    "Triceps Dips (Assisted)": ex("arms", "machine", "compound", "push", direction="vertical", weight=0, reps=10, bw=0.6,
    ...
    "Burpees": ex("chest", "bodyweight", "compound", "push", direction="horizontal", weight=0, reps=12, bw=0.6, prime=["pectorals"], major=["triceps", "quads", "glutes"], minor=["deltoids", "abs"]),
    ...
    "Flat Machine Press": ex("chest", "machine", "compound", "push", direction="horizontal", weight=90, reps=10, prime=["pectorals"], major=["triceps"], minor=["deltoids"]),
    ...
    "Incline Bench Press - Dumbbell": ex("chest", "dumbbell", "compound", "push", direction="horizontal", weight=40, reps=8, prime=["pectorals"], major=["deltoids"], minor=["triceps"]),
    ...
    "Incline Chest Press DB": ex("chest", "dumbbell", "compound", "push", direction="horizontal", weight=40, reps=10, prime=["pectorals"], major=["deltoids"], minor=["triceps"]),
    ...
    "Isometric Wipers": ex("chest", "bodyweight", "compound", "push", direction="horizontal", weight=0, reps=12, bw=0.6, prime=["pectorals"], major=["triceps"], minor=["deltoids", "abs"]),
    ...
    "Machine Chest Press Exercise": ex("chest", "machine", "compound", "push", direction="horizontal", weight=100, reps=10, prime=["pectorals"], major=["triceps"], minor=["deltoids"]),
    ...
    "Push-Ups | Decline": ex("chest", "bodyweight", "compound", "push", direction="horizontal", weight=0, reps=15, bw=0.7, prime=["pectorals"], major=["triceps"], minor=["deltoids"]),
    "Push-Ups | Incline": ex("chest", "bodyweight", "compound", "push", direction="horizontal", weight=0, reps=15, bw=0.5, prime=["pectorals"], major=["triceps"], minor=["deltoids"]),
    ...
    # ---- Back ----
    "1-Arm Half-Kneeling Lat Pulldown": ex("back", "cable", "compound", "pull", direction="vertical", weight=50, reps=12, lat="unilateral", prime=["lats"], major=["biceps"], minor=["teres", "rhomboids"], aliases=["Half-Kneeling Single-Arm Pulldown"]),
    "Alternating High Cable Row": ex("back", "cable", "compound", "pull", direction="horizontal", weight=80, reps=12, prime=["lats", "rhomboids"], major=["biceps"], minor=["traps", "teres"], aliases=["Alternating Cable High Row"]),
    "Alternative DB Gorilla rows": ex("back", "dumbbell", "compound", "pull", direction="horizontal", weight=70, reps=10, lat="unilateral", prime=["lats", "rhomboids"], major=["biceps", "traps"], minor=["teres", "forearms"], aliases=["Gorilla Row", "Dumbbell Gorilla Row"]),
    "Assisted chin-ups": ex("back", "machine", "compound", "pull", direction="vertical", weight=60, reps=10, bw=0.4, prime=["lats", "biceps"], minor=["teres", "rhomboids", "forearms"], aliases=["Assisted Chin-up", "Machine Assisted Chin-up"]),
    ...
    "Barbell Row (Overhand)": ex("back", "barbell", "compound", "pull", direction="horizontal", weight=115, reps=8, prime=["lats", "rhomboids"], major=["traps", "biceps"], minor=["teres", "lowerBack"], aliases=["Pronated Barbell Row", "Overhand Bent-Over Row"]),
    "Barbell Row (Underhand)": ex("back", "barbell", "compound", "pull", direction="horizontal", weight=115, reps=8, prime=["lats", "rhomboids"], major=["biceps"], minor=["traps", "teres", "lowerBack"], aliases=["Supinated Barbell Row", "Underhand Bent-Over Row"]),
    "Bent over row to external rotation": ex("back", "dumbbell", "compound", "pull", direction="horizontal", weight=15, reps=12, plane="transverse", prime=["rhomboids", "deltoids"], major=["traps"], minor=["lats", "teres"], aliases=["Row to External Rotation"]),
    ...
    "Face pulls with yellow/green band": ex("back", "band", "compound", "pull", direction="horizontal", weight=0, reps=20, prime=["deltoids"], major=["traps", "rhomboids"], minor=["teres"], aliases=["Band Face Pull"]),
    "Front Pull narrow": ex("back", "cable", "compound", "pull", direction="vertical", weight=100, reps=10, prime=["lats"], major=["biceps"], minor=["teres", "rhomboids"], aliases=["Narrow-Grip Front Pulldown"]),
    "Front pull wide": ex("back", "cable", "compound", "pull", direction="vertical", weight=110, reps=10, prime=["lats"], major=["biceps"], minor=["teres", "rhomboids", "traps"], aliases=["Wide-Grip Front Pulldown"]),
    ...
    "High Row": ex("back", "machine", "compound", "pull", direction="horizontal", weight=110, reps=10, prime=["lats", "rhomboids"], major=["biceps", "traps"], minor=["teres"], aliases=["Machine High Row"]),
    ...
    "Incline Chest-Supported Dumbbell Row": ex("back", "dumbbell", "compound", "pull", direction="horizontal", weight=45, reps=10, prime=["lats", "rhomboids"], major=["biceps"], minor=["traps", "teres"], aliases=["Chest-Supported Incline DB Row", "Dumbbell Prone Row"]),
    ...
    "Lat Pull Down (Leaning Back)": ex("back", "cable", "compound", "pull", direction="vertical", weight=110, reps=10, prime=["lats"], major=["biceps"], minor=["teres", "rhomboids", "traps"], aliases=["Leaning-Back Lat Pulldown"]),
    "Lat Pull Down (Straight Back)": ex("back", "cable", "compound", "pull", direction="vertical", weight=100, reps=10, prime=["lats"], major=["biceps"], minor=["teres", "rhomboids"], aliases=["Straight-Back Lat Pulldown"]),
    "Long-Pulley (low Row)": ex("back", "cable", "compound", "pull", direction="horizontal", weight=110, reps=10, prime=["lats", "rhomboids"], major=["biceps"], minor=["traps", "teres"], aliases=["Low Cable Row", "Long Pulley Row"]),
    "Long-Pulley, Narrow": ex("back", "cable", "compound", "pull", direction="horizontal", weight=100, reps=10, prime=["lats", "rhomboids"], major=["biceps"], minor=["traps", "teres"], aliases=["Narrow-Grip Cable Row"]),
    ...
    "One-Arm Heavy Row": ex("back", "dumbbell", "compound", "pull", direction="horizontal", weight=80, reps=10, lat="unilateral", prime=["lats", "rhomboids"], major=["biceps", "traps"], minor=["teres", "forearms"], aliases=["Heavy One-Arm Dumbbell Row"]),
    ...
    "Pull Ups on Machine": ex("back", "machine", "compound", "pull", direction="vertical", weight=60, reps=10, bw=0.4, prime=["lats"], major=["biceps"], minor=["teres", "rhomboids"], aliases=["Machine Assisted Pull-up"]),
    ...
    "Rope Pullover/row": ex("back", "cable", "compound", "pull", direction="horizontal", weight=70, reps=12, prime=["lats"], major=["rhomboids", "biceps"], minor=["teres"], aliases=["Rope Cable Pullover Row"]),
    "Rowing with TRX band": ex("back", "bodyweight", "compound", "pull", direction="horizontal", weight=0, reps=12, bw=0.6, prime=["lats", "rhomboids"], major=["biceps"], minor=["traps", "teres", "abs"], aliases=["TRX Row", "Suspension Row"]),
    ...
    "Shotgun Row": ex("back", "cable", "compound", "pull", direction="horizontal", weight=50, reps=12, plane="transverse", lat="unilateral", prime=["lats", "rhomboids"], major=["biceps"], minor=["teres", "obliques"], aliases=["Single-Arm Shotgun Row"]),
    ...
    "Single arm row": ex("back", "dumbbell", "compound", "pull", direction="horizontal", weight=50, reps=10, lat="unilateral", prime=["lats", "rhomboids"], major=["biceps"], minor=["traps", "teres"]),
    ...
    "Typewriter Pull-ups": ex("back", "bodyweight", "compound", "pull", direction="vertical", weight=0, reps=6, bw=1.0, prime=["lats"], major=["biceps"], minor=["teres", "rhomboids", "forearms"], aliases=["Typewriter Pull-up"]),
    ...
    "Barbell Clean and press": ex("shoulders", "barbell", "compound", "push", direction="vertical", weight=95, reps=5, prime=["deltoids"], major=["triceps", "quads"], minor=["traps", "glutes"]),
    ...
    "Clean and Jerk OL": ex("shoulders", "barbell", "compound", "push", direction="vertical", weight=135, reps=2, prime=["deltoids"], major=["quads", "glutes", "triceps"], minor=["hamstrings", "traps"]),
    ...
    "Jerk OL": ex("shoulders", "barbell", "compound", "push", direction="vertical", weight=135, reps=2, prime=["deltoids"], major=["triceps", "quads", "glutes"], minor=["traps"]),
    ...
    "Military Press mit SZ-Bar": ex("shoulders", "barbell", "compound", "push", direction="vertical", weight=75, reps=8, prime=["deltoids"], major=["triceps"], minor=["traps"]),
    "Overhead Barbell Press": ex("shoulders", "barbell", "compound", "push", direction="vertical", weight=95, reps=8, prime=["deltoids"], major=["triceps"], minor=["traps"]),
    ...
    "Push OHP": ex("shoulders", "barbell", "compound", "push", direction="vertical", weight=115, reps=5, prime=["deltoids"], major=["triceps", "quads", "glutes"], minor=["traps"]),
    ...
    "Shoulder Press, Barbell": ex("shoulders", "barbell", "compound", "push", direction="vertical", weight=95, reps=8, prime=["deltoids"], major=["triceps"], minor=["traps"]),
    ...
    "Australian pull-ups": ex("arms", "bodyweight", "compound", "pull", direction="horizontal", weight=0, reps=12, bw=0.6, prime=["lats", "rhomboids"], major=["biceps"], minor=["traps", "teres", "forearms"]),
    "Barbell Triceps Extension": ex("arms", "barbell", "isolation", None, weight=55, reps=10, prime=["triceps"]),
    "Bench Dips On Floor HD": ex("arms", "bodyweight", "compound", "push", direction="vertical", weight=0, reps=12, bw=0.45, prime=["triceps"], minor=["pectorals", "deltoids"]),
    "Bench Press Narrow Grip": ex("arms", "barbell", "compound", "push", direction="horizontal", weight=115, reps=8, prime=["triceps"], major=["pectorals"], minor=["deltoids"]),
    "Biceps Close Grip Pull Down": ex("arms", "cable", "compound", "pull", direction="vertical", weight=80, reps=10, prime=["biceps"], major=["lats"], minor=["forearms", "rhomboids"]),
    ...
    "Double Kettlebell Clean and Press": ex("arms", "kettlebell", "compound", "push", direction="vertical", weight=35, reps=6, prime=["deltoids"], major=["triceps", "quads"], minor=["traps", "glutes"]),
    ...
    "Dumbbell Underhand Dead Row": ex("arms", "dumbbell", "compound", "pull", direction="horizontal", weight=50, reps=10, prime=["lats", "rhomboids"], major=["biceps"], minor=["traps", "teres"]),
    ...
    "Floor dips": ex("arms", "bodyweight", "compound", "push", direction="vertical", weight=0, reps=12, bw=0.45, prime=["triceps"], minor=["pectorals", "deltoids"]),
    ...
    "L-Sit Pull-ups": ex("arms", "bodyweight", "compound", "pull", direction="vertical", weight=0, reps=8, bw=1.0, prime=["lats"], major=["biceps"], minor=["teres", "rhomboids", "abs", "hipFlexors"]),
    ...
    "Lat Pull DB": ex("back", "dumbbell", "compound", "pull", direction="vertical", weight=45, reps=12, prime=("lats",), major=("teres",), minor=("pectorals", "triceps"), trace=("serratus",), aliases=["Dumbbell Lat Pullover"]),
    "Lying Dumbbell Row SS Seated Shrug": ex("back", "dumbbell", "compound", "pull", direction="horizontal", weight=40, reps=10, prime=("lats", "traps"), major=("rhomboids",), minor=("biceps", "teres"), trace=("forearms", "deltoids")),
    ...
    "Upper Back": ex("back", "machine", "compound", "pull", direction="horizontal", weight=70, reps=12, plane="transverse", prime=("rhomboids",), major=("traps", "teres"), minor=("deltoids", "lats"), trace=("biceps",)),
    "Wide Pull Up": ex("back", "bodyweight", "compound", "pull", direction="vertical", reps=8, bw=1.0, prime=("lats",), major=("teres",), minor=("rhomboids", "biceps"), trace=("traps", "forearms")),

    "Kreis Press DB": ex("shoulders", "dumbbell", "compound", "push", direction="vertical", weight=35, reps=10, aliases=["Arnold Press", "Circle Press"], prime=("deltoids",), major=("triceps",), minor=("traps",), trace=("serratus",)),
    ...
    "Glute Bridge Single-Arm Press": ex("core", "dumbbell", "compound", "push", direction="horizontal", weight=35, reps=10, lat="unilateral", prime=["pectorals", "triceps"], major=["glutes"], minor=["deltoids", "abs"], aliases=["Glute Bridge Floor Press", "Single-Arm Bridge Press"]),
    "Neutral-grip pull-ups or TRX rows": ex("back", "bodyweight", "compound", "pull", direction="vertical", weight=0, reps=8, bw=1.0, prime=["lats"], major=["biceps"], minor=["teres", "rhomboids", "forearms"], aliases=["Neutral-Grip Pull-up", "TRX Row", "Suspension Row"]),
    ...
    "commando pull-ups": ex("back", "bodyweight", "compound", "pull", direction="vertical", reps=8, bw=1.0, prime=("lats",), major=("biceps", "rhomboids"), minor=("traps", "teres", "forearms"), trace=("abs",), aliases=["Commando Pull-Up", "Alternating Grip Pull-Up"]),
    "TRX Rows": ex("back", "bodyweight", "compound", "pull", direction="horizontal", reps=12, bw=0.6, prime=("lats", "rhomboids"), major=("biceps", "traps"), minor=("teres", "deltoids"), trace=("forearms", "abs"), aliases=["TRX Inverted Row"]),
    "Horizontal traction isometry": ex("back", "bodyweight", "compound", "pull", direction="horizontal", reps=1, bw=0.6, tracking="duration", duration=30, prime=("lats", "rhomboids"), major=("biceps", "traps"), minor=("teres", "deltoids"), trace=("forearms", "abs"), aliases=["Isometric Row Hold"]),
    ...
    "Pullup on fingerboard": ex("back", "bodyweight", "compound", "pull", direction="vertical", reps=5, bw=1.0, prime=("lats",), major=("biceps", "forearms"), minor=("teres", "rhomboids"), trace=("traps",), aliases=["Hangboard Pull-up", "Fingerboard Pull-up"]),
    ...
    "Strict Press-Ups": ex("chest", "bodyweight", "compound", "push", direction="horizontal", reps=12, bw=0.64, prime=["pectorals"], major=["triceps"], minor=["deltoids"], trace=["serratus", "abs"], aliases=["Strict Push-Up", "Strict Push-Ups"]),
    ...
    # — Upper body pull —
    "Kettlebell Row and Rotate": ex("back", "kettlebell", "compound", "pull", direction="horizontal", weight=35, reps=10, lat="unilateral", plane="transverse", prime=["lats"], major=["rhomboids", "biceps"], minor=["obliques", "traps"], trace=["teres", "forearms"], aliases=["KB Row and Rotate", "Row to Rotation"]),
    "KB/DB Drags": ex("back", "dumbbell", "compound", "pull", direction="horizontal", weight=35, reps=10, lat="unilateral", prime=["lats"], major=["rhomboids", "biceps"], minor=["abs", "traps"], trace=["teres", "forearms"], aliases=["Drag Row", "Kettlebell Drag", "Dumbbell Drag"]),
