...
CURATION = {
    ...
    "Pullover": ex("back", "dumbbell", "isolation", None, weight=50, reps=12, prime=["lats"], minor=["pectorals", "teres", "triceps"], aliases=["Bent-Arm Pullover"]),
    ...
    "Handstand Pushup": ex("shoulders", "bodyweight", "compound", "push", weight=0, reps=6, bw=0.9, prime=["deltoids", "triceps"], minor=["pectorals", "traps"]),
    ...
    "Wall Squat": ex("legs", "bodyweight", "compound", "squat", reps=1, tracking="duration", duration=45, bw=0.6, aliases=["Wall Sit"], prime=("quads",), major=("glutes",), minor=("hamstrings", "adductors", "calves")),
    ...
    "3008 Abdominal Crunch": ex("core", "bodyweight", "isolation", None, reps=15, bw=0.3, prime=("abs",), minor=("obliques",), trace=("hipFlexors",)),
    "Abdominal Crunch": ex("core", "bodyweight", "isolation", None, reps=15, bw=0.3, prime=("abs",), minor=("obliques",), trace=("hipFlexors",)),
    "Crunches HD": ex("core", "bodyweight", "isolation", None, reps=15, bw=0.3, prime=("abs",), minor=("obliques",), trace=("hipFlexors",)),
    "Levitation Crunch": ex("core", "bodyweight", "isolation", None, reps=15, bw=0.3, prime=("abs",), minor=("obliques",), trace=("hipFlexors",)),
    "Negative Crunches": ex("core", "bodyweight", "isolation", None, reps=12, bw=0.3, prime=("abs",), minor=("obliques",), trace=("hipFlexors",)),
    ...
    "Leg Raises, Lying": ex("core", "bodyweight", "isolation", None, reps=15, bw=0.4, prime=("abs", "hipFlexors"), minor=("obliques",), trace=("quads",), aliases=["Lying Leg Raise"]),
    "Front Plank": ex("core", "bodyweight", "isolation", None, reps=1, bw=0.6, tracking="duration", duration=60, prime=("abs",), major=("obliques",), minor=("lowerBack",), trace=("deltoids", "glutes", "quads"), aliases=["Plank"]),
